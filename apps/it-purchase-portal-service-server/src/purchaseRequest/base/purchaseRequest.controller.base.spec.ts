...
const service = {
  ...
  purchaseRequests: () => FIND_MANY_RESULT,
  purchaseRequest: ({ where }: { where: { id: string } }) => {
    switch (where.id) {
      case existingId:
...
describe("PurchaseRequest", () => {
  ...
  test("POST /purchaseRequests", async () => {
  ...
  test("GET /purchaseRequests", async () => {
    await request(app.getHttpServer())
  ...
  test("GET /purchaseRequests/:id non existing", async () => {
    await request(app.getHttpServer())
      .get(`${"/purchaseRequests"}/${nonExistingId}`)
  ...
  test("GET /purchaseRequests/:id existing", async () => {
    await request(app.getHttpServer())
      .get(`${"/purchaseRequests"}/${existingId}`)
      .expect(HttpStatus.OK)
      .expect({
        ...FIND_ONE_RESULT,
  ...
  test("POST /purchaseRequests existing resource", async () => {
